...
plt.plot(df["orderDate"][:train_size], df["totalAmount"][:train_size], label="Train")
plt.plot(df["orderDate"][train_size:], df["totalAmount"][train_size:], label="Actual")
plt.plot(df["orderDate"][train_size:], y_pred, label="Predicted")
plt.legend()
plt.tight_layout()
